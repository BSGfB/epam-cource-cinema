...
@Profile("database")
public class JdbcEventPriceByNameCounterService implements CounterService {

    final CounterDao counterDao;

    @Autowired
    public JdbcEventPriceByNameCounterService(@Qualifier("JdbcEventPriceByNameCounterDao") CounterDao counterDao) {
