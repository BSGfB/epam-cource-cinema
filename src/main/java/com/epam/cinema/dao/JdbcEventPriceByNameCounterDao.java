...
@Component
@Qualifier("JdbcEventPriceByNameCounterDao")
@Profile("database")
public class JdbcEventPriceByNameCounterDao implements CounterDao  {

    private static final String NAME = "name";
    private static final String COUNTER = "counter";

    @Value("${query.JdbcEventPriceByNameCounter.save}")
    private String save;

    @Value("${query.JdbcEventPriceByNameCounter.increaseCounter}")
    private String increaseCounter;

    @Value("${query.JdbcEventPriceByNameCounter.getByName}")
    private String getByName;

    @Value("${query.JdbcEventPriceByNameCounter.getAll}")
    private String getAll;

    private NamedParameterJdbcTemplate jdbcTemplate;

    @Autowired
    public JdbcEventPriceByNameCounterDao (DataSource dataSource) {
